...
import 'about_us_patient_model.dart';
export 'about_us_patient_model.dart';
...
class AboutUsPatientWidget extends StatefulWidget {
  const AboutUsPatientWidget({super.key});

  static String routeName = 'AboutUsPatient';
  static String routePath = '/aboutUsPatient';

  @override
  State<AboutUsPatientWidget> createState() => _AboutUsPatientWidgetState();
}

class _AboutUsPatientWidgetState extends State<AboutUsPatientWidget> {
  late AboutUsPatientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboutUsPatientModel());
  }
