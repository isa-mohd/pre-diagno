...
import 'about_us_med_model.dart';
export 'about_us_med_model.dart';
...
class AboutUsMedWidget extends StatefulWidget {
  const AboutUsMedWidget({super.key});

  static String routeName = 'AboutUsMed';
  static String routePath = '/aboutUsMed';

  @override
  State<AboutUsMedWidget> createState() => _AboutUsMedWidgetState();
}

class _AboutUsMedWidgetState extends State<AboutUsMedWidget> {
  late AboutUsMedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboutUsMedModel());
  }
